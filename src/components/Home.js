  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
      <div className='max-w-[1200px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <h2 className='py-[5px] text-4xl sm:text-7xl font-medium text-[#a5a8b1]'>I'm your next Full Stack Engineer!</h2>
        <p className='text-[#d4d5d8] py-4 max-w-[700px] text-2xl'>I specialize in creating exceptional user experiences through modern and well thoughtout design.</p>
        <div>
