  ...
  return (
    <div name="home" className="w-screen h-screen bg-[#0a192f]">
      <div className="max-w-fit mx-auto px-8 sm:px-24 flex flex-col justify-center h-full">
        ...
        <p className="text-[#c3c4c9] py-4 max-w-[700px] xl:max-w-4xl text-lg xl:text-xl mt-2">
        ...
        <Link to="projects" smooth={true} duration={500} offset={-150}>
          <button className="text-white border-2 px-4 py-3 p-4 my-2 rounded-md flex items-center hover:bg-[#9d0885] hover:border-[#9d0885] duration-300 group">
            View Work
