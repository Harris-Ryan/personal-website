  ...
  return (
    <div name="home" className="w-screen h-screen bg-[#0a192f]">
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <p className="text-[#c3c4c9] py-4 max-w-[700px]">
        ...
        <div>
          <Link to="projects" smooth={true} duration={500} offset={120}>
            <button className="text-white border-2 px-6 py-3 my-2 rounded-md flex items-center leading-none hover:bg-[#9d0885] hover:border-[#9d0885] duration-300 group">
              View Work
