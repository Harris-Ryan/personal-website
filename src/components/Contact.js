  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4 pt-[50px]'>
      <div className='flex flex-col max-w-[750px] w-full'>
        <div className='pb-8'>
          <p className='text-4xl font-bold inline border-b-4 border-[#9d0885] text-[#ffffff]'>Contact</p>
        ...
        <form className='flex flex-col' ref={form} onSubmit={sendEmail}>
          ...
          <div className='flex items-center justify-center'>
            <button className='text-white border-2 px-8 py-3 my-5 rounded-md flex items-center hover:bg-[#9d0885] hover:border-[#9d0885] duration-300' type='submit'>
              Send Message
            </button>
          </div>
        </form>
